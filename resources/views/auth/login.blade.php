            ...
            <div class="section">
                <style>
                    .small-image {
                        ...
                        height: auto; /* Tinggi akan mengikuti lebar secara proporsional */
                    }
                </style>
                <img src="assets/img/login/login.webp"  class="small-image" alt="Gambar Kecil dengan CSS">
                {{-- alt="small-image" class="form-image" --}}
            </div>
            <div class="section mt-1">
                <h1>Selamat Datang</h1>
                <h4>Silahkan melakukan login terlebih dahulu</h4>
            </div>
                  ...
                  @csrf
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" name="nik" class="form-control" id="nik" placeholder="NISN">
                            <i class="clear-input">
